...
@Component({
  selector: 'app-communities-backup',
  standalone: true,
  imports: [CommonModule, RouterModule, CommunityProjectsComponent],
  templateUrl: './communities-backup.component.html',
  styleUrl: './communities-backup.component.css'
})
export class CommunitiesBackupComponent implements OnInit {
